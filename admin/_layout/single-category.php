...
<title><?php echo $page_product_category;?> Products &mdash; SimGanic</title>
        ...
        <div class="main-content">
            <section class="section">
                ...
                <div class="section-body">
                    <h5 class="section-title">Fresly Added <?php echo $page_product_category;?> Products</h5>
                    <div class="row">
                    <?php
                    ...
                    ?>
                        <div class="col-12 col-md-3 col-lg-3 prod-div">
                    ...
                    <h5 class="section-title">All <?php echo $page_product_category;?> Products</h5>
                    <div class="row">
                    <?php
