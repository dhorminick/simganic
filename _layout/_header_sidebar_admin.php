            ...
            <ul class="navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="my-account" class="dropdown-item has-icon caps"><i class="far fa-user"></i> My Account</a>
                        <a href="wishlist" class="dropdown-item has-icon caps"><i class="fas fa-heart-circle-check"></i> My Wishlist</a>
        ...
        <div class="main-sidebar sidebar-style-3">
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a class="nav-link" href="update-currencies"><i class="fa fa-currency"></i> <span>Update Currencies</span></a></li>
