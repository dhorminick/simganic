<footer class="main-footer">
		...
		<div class="col-12 col-lg-5">
			<div class="form-group">
				...
				<div class="input-group">
                  	...
                  	<input type="email" class="form-control input-newsletter" name="newsletter-email" placeholder="Email" required>
	...
	<div class="show-sm"><br></div>
	<div class="row footer-body">
		<div class="col-6 col-lg-3 col-md-6 col-footer-link">
			<h6>How To?</h6>
			<ul>
				<li><a href="/faqs#return-product">Report a Product?</a><br></li>
				<li><a href="/faqs#cancel-product">Cancel an Order?</a><br></li>
				<li><a href="/faqs#report-product">Return a Product?</a><br></li>
				<li><a href="/faqs#using-simganic">Shop on SimGanic?</a><br></li>
			</ul>
		</div>
		<div class="col-6 col-lg-2 col-md-6 col-footer-link">
			<h6>Account</h6>
			<ul>
			<?php
		...
		<div class="col-6 col-lg-4 col-md-6 col-footer-link">
			<h6>Transport Offices</h6>
			<ul>
				<li style="display:none;"><i class="fa fa-location-dot"></i> Address.<br></li>
				<li><i class="fa fa-phone"></i> <a href="tel:0800000000">080-0000-0000</a> <div class="bullet"></div> 10am - 6pm (Mondays to Saturdays)<br></li>
				<li><i class="fa fa-envelope"></i> <a href="mailto:support@simganic.com">support@simganic.com</a><br></li>
				<li><i class="fa-brands fa-whatsapp"></i> Chat Open 24 hrs - 7 days<br></li>
			</ul>
		</div>
